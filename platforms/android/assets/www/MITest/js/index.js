...
//                                            }, 1500);
	...
	fillServices: function(){
		...
		//if the device is xiaomi band
		if(app.device.deviceName == "MI"){
			var mi = app.device;
			setTimeout(function(){
			...
			setTimeout(function(){
				mi.services[2].characteristics[5].subscribe(function(){
					alert(2);
				}
			)},250);			
			setTimeout(function(){
				mi.services[2].characteristics[6].subscribe(function(){
					alert(3);
				}
			)},450);
			setTimeout(function(){
				mi.services[2].characteristics[11].subscribe(function(){
					alert(4);
				}
			)},650);
			setTimeout(function(){
			...
			setTimeout(function(){
				mi.services[2].characteristics[3].write("Hex","D168C4280118AA420036383339363035323900AF",function(){
					alert("write secureID success!!!");
				},function(){
					alert("write error!!!");
				}
			)},1050);
	...
	startListening : function(){
		app.device.services[2].characteristics[4].write("Hex","1201",function(){
	...
	stopListening : function(){
		app.device.services[2].characteristics[4].write("Hex","1200",function(){
			alert("stop listening success.");
		},function(){
			alert("write error!!!");
		})	
	},
	...
	getChar: function(serviceIndex){
		...
		app.device.services[serviceIndex].discoverCharacteristics(function(){
			...
			alert(app.device.services[serviceIndex].characteristics[0].uuid);
		},function(){
