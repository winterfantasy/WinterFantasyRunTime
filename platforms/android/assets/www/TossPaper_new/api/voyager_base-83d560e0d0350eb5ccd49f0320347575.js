...
var addToHome = function(e) {
    ...
    function E() {
        ...
        y.touchIcon && (n = i ? "http://games.localhost/assets/images/touch-icon-iphone-retina.png": "http://games.localhost/assets/images/touch-icon-iphone.png", n ? n = '<span style="background-image:url(' + n + ')" class="addToHomeTouchIcon"></span>': n = ""),
...
function() {
    ...
    Softgames.prototype.defaultSubsystem = "m.localhost",
    ...
    Softgames.prototype._apiRequest = function(e, t, n, r, i) {
        var s;
        //return t = this._apiUrl(t, n),
	return t="./loaddata.json",
        navigator.userAgent.toLowerCase().indexOf("androoid") >= 0 && e === "GET" && (t += "&android-buster=" + Math.random()),
        s = this._openXHR(e, t),
        s.setRequestHeader("Content-Type", "application/json-rpc"),
    ...
    Softgames.prototype._init = function(e) {
        ...
        this.openx_host = "http://ads.localhost/www/delivery/",
        this._getUrlParameters().host ? this.kirk_host = "//" + unescape(this._getUrlParameters().host) + "/api/": this.kirk_host = "http://m.localhost/api/",
        this.system_id = this._getSystemId(),
        this.game_slug = this._getGameSlug(),
        this.defaultBackUrl = "http://m.localhost/",
