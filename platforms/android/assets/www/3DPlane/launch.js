...
(function() {
  ...
  s = [['controlType', ['KEYBOARD', 'TOUCH', 'LEAP MOTION CONTROLLER', 'GAMEPAD','Sensor Tag'], 4, 4, 'Controls: '], ['quality', ['LOW', 'MID', 'HIGH', 'VERY HIGH'], 2, 2, 'Quality: '], ['hud', ['OFF', 'ON'], 1, 1, 'HUD: '], ['godmode', ['OFF', 'ON'], 0, 1, 'Godmode: ']];
